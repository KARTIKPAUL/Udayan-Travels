        ...
        <div className="row g-5">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2">
              ...
              Sankar Chowmuhani, 4, Ram Nagar Rd, Krishna Nagar, Agartala, Tripura 799002
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              ...
              support@udayantravels.com
            </p>
            <div className="d-flex pt-2">
              <a className="btn btn-outline-light btn-social" href="/">
                <i className="fab fa-twitter" />
              </a>
              <a className="btn btn-outline-light btn-social" href="https://www.facebook.com/UdayanTravels/">
