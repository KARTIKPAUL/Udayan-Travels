          ...
          <Row className="justify-content-center">
            <Col md={10}>
              <Card className="shadow p-4">
                ...
                <ul>
                  <li><strong>Email:</strong> support@udayantravels.com</li>
                  <li><strong>Phone:</strong> 087941 68592</li>
                  <li><strong>Address:</strong> Sankar Chowmuhani, 4, Ram Nagar Rd, Krishna Nagar, Agartala, Tripura 799002</li>
                </ul>
              </Card>
            </Col>
          </Row>
