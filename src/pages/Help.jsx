          ...
          <Row className="justify-content-center">
            <Col md={10}>
              <Card className="shadow p-4">
                ...
                <p>
                  At <strong>Udayan Travels</strong>, we are dedicated to providing excellent customer support. Below, you will find answers to some of the most frequently asked questions.
                </p>
                ...
                <ul>
                  <li>
                    <strong>Email:</strong> support@udayantravels.com
                  </li>
                  <li>
                    <strong>Phone:</strong> 087941 68592
                  </li>
                  <li>
                    <strong>Address:</strong> Sankar Chowmuhani, 4, Ram Nagar Rd, Krishna Nagar, Agartala, Tripura 799002
                  </li>
                </ul>
